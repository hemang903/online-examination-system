...
<head>
	...
	<link rel="shortcut icon" href="image/10.jpg" type="image/jpg" >
			...
			<div class="wrap-login100">
				...
				<form method="post" id="examineeLoginFrm" class="login100-form validate-form">
					...
					<div class="container-login100-form-btn" align="right">
						<button type="submit" class="button-92">
							Login
						</button>
						
					</div>
					<!-- <div class="signup-link">
                     Not a member?  <a href="" data-toggle="modal" data-target="#modalForAddExaminee">Sign Up</a>
                  </div> -->
				</form>
			</div>
		</div>
